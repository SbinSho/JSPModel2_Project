...
var chart = new CanvasJS.Chart("chartContainer", {
   ...
   //axisX 객체를 사용하면 간격, 격자 선 등과 같은 X 축의 다양한 매개 변수를 설정가능
   axisX:{
   	  // X축 제목 추가
      title: "시간"
   },
   //axisY 객체를 사용하면 간격, 격자 선 등과 같은 Y 축의 다양한 매개 변수를 설정가능
   axisY:{
	  // Y축 접미사 추가
	  suffix: "%"
   },
   ...
   data: [{
      ...
      // y 축 값의 출력 형식을 지정
      yValueFormatString: "#,###",
      // 그래프에 마우스 오버시 사용자에게 보여줄 현재 그래프의 정보의 출력 방식을 지정 
      toolTipContent: "{y}",
      // 차트에 그려야하는 값을 지정한다. 즉 표시할 그래프의 x, y 및 레이블 지정
